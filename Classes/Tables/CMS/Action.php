...
// // $url = App\Core\Web::url('site.ajax.workforce.offer');
//
// // Set the url
// curl_setopt($curl, CURLOPT_URL, $url);
// // curl_setopt($curl, CURLOPT_POST, 1);
// curl_setopt($curl, CURLOPT_POSTFIELDS, http_build_query(array(
//     'form_token' => App\Core\Session::token('form'),
//     'ajax_token' => App\Core\Session::token('ajax'),
//     'ana' => 'mere'
// )));
...
// exit;
//
// $curl = curl_init(App\Core\Web::url('site.ajax.workforce.offer'));
//
