<div class="row">
    <?= Arshwell\Monolith\Module\HTML\Piece::actions(
        array('CMS', 'Conținut', 'General', Arshavinel\ElleTherapy\View\CMS::sentence($source ?: 'view.global', NULL, true)),
        array(
            array(
                'HTML' => array(
                    ...
                    'type'  => 'link',
                    'href'  => Arshwell\Monolith\Web::url('cms.cms.content.general.all'),
