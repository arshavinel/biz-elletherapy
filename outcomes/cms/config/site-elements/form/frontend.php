<div class="row">
    <?= App\Core\Module\HTML\Piece::actions(array('Setări', 'Elemente site')) ?>
</div>

<div class="arshmodule">
    <form class="arshmodule-form" method="POST" action="<?= App\Core\Web::url('cms.config.site-elements.ajax.update') ?>">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-3">
