...
use App\Core\Table\TableColumn;
use App\Core\Table\TableField;
use App\Core\Table\TableFiles;
use App\Core\Table;
use App\Core\Text;
use App\Core\File;
use App\Core\Func;
    ...
    static function feature (string $key, $feature, int $id_table): string {
        ...
        foreach ($feature as $category => $attributes) {
            foreach ($attributes as $attr => $value) {
                $feature[$category][$attr] = ("App\Core\Module\Syntax\Frontend\Feature\\{$category}")::{$attr}($value);
            }
        }
