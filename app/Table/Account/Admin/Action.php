...
final class Action extends Table {
    ...
    static function save (array $get, array $post, array $files = array()): int {
        ...
        return self::insert(
            "id_profile_session, route, request, params, inserted_at",
            "?, ?, ?, ?, UNIX_TIMESTAMP()",
            array(Profile::auth('id_profile_session'), Web::key(), Web::request(), json_encode($params, JSON_INVALID_UTF8_IGNORE))
        );
    }
}
...
// // $url = Arshwell\Monolith\Web::url('site.ajax.workforce.offer');
//
// // Set the url
// curl_setopt($curl, CURLOPT_URL, $url);
// // curl_setopt($curl, CURLOPT_POST, 1);
// curl_setopt($curl, CURLOPT_POSTFIELDS, http_build_query(array(
//     'form_token' => Arshwell\Monolith\Session::token('form'),
//     'ajax_token' => Arshwell\Monolith\Session::token('ajax'),
//     'ana' => 'mere'
// )));
...
// exit;
//
// $curl = curl_init(Arshwell\Monolith\Web::url('site.ajax.workforce.offer'));
//
