...
<body>
	<div id="border">
		...
		<p><?= Arshavinel\ElleTherapy\View\Site::content('programări', array(
			'link' => '<a target="_blank" href="'. Arshwell\Monolith\Web::url('cms.forms.appointment') .'">'.
				Arshavinel\ElleTherapy\View\Site::sentence('programări.link.text') .
			'</a>'
		)) ?></p>
